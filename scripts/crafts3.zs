...
mods.thaumcraft.Infusion.registerRecipe("wtf", "", <thaumadditions:adaminite_ingot>, 9, [<aspect:spiritus>*60, <aspect:victus>*50, <aspect:praecantatio>*50, <aspect:infernum>*50, <aspect:permutatio>*20, <aspect:metallum>*20, <aspect:draco>*20, <aspect:alkimia>*15, <aspect:visum>*10], <thaumadditions:mithrillium_ingot>, [<ore:adamantComponent>, <abyssalcraft:dreadplate>, <embers:ashen_cloth>, <thaumcraft:fabric>, <ore:adamantComponent>, <naturesaura:sky_ingot>, <embers:ashen_cloth>, <thaumcraft:primordial_pearl>.anyDamage()]);
mods.thaumcraft.Infusion.registerRecipe("wtf1", "", <thaumadditions:mithminite_ingot>, 9, [<aspect:praecantatio>*80, <aspect:metallum>*60, <aspect:victus>*50, <aspect:caeles>*30], <thaumadditions:adaminite_ingot>, [<astralsorcery:itemcraftingcomponent:2>, <thaumcraft:quicksilver>, <twilightforest:carminite>, <extrabotany:material:7>, <evilcraft:garmonbozia>, <thaumcraft:quicksilver>, <bloodmagic:component:14>, <extrabotany:material:8>]);	
mods.thaumcraft.Infusion.registerRecipe("wtf1322", "ICHOR", <ichoriumkit:ichor_block>, 15, [<aspect:spiritus>*500, <aspect:lux>*250, <aspect:humanus>*250, <aspect:caeles>*250], <ore:netherStar>, [<bloodarsenal:blood_diamond:1>, <ichoriumkit:resourcekami>, <vampirism:blood_infused_enhanced_iron_ingot>, <botania:manaresource:14>, <minecraft:nether_star>, <embers:wildfire_core>, <ichoriumkit:resourcekami:1>, <extrabotany:material:3>, <thaumadditions:mithminite_ingot>, <minecraft:nether_star>]);
